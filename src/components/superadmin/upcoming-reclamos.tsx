...
import { ChevronDown, ChevronUp, Calendar, User, MapPin, Eye } from "lucide-react";
import { ReclamoDetailSheet } from "@/components/reclamos/reclamo-detail-sheet";
...
export function SuperadminUpcomingReclamos() {
  ...
  const displayedReclamos = showAll ? reclamos : reclamos.slice(0, 5);
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-2xl">Próximos Reclamos</CardTitle>
          <Button
            variant="ghost"
            size="sm"
