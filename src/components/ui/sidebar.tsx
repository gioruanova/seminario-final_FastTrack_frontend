...
function SidebarProvider({
  ...
  // openProp y setOpenProp permiten control externo del componente
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Guardar el estado en cookie para persistir entre sesiones
  ...
  // Esto facilita el styling con clases de Tailwind
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Ajustar padding para variantes floating e inset
          variant === "floating" || variant === "inset"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "overflow-clip relative flex w-full flex-1 flex-col",
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-item relative gap-2", className)}
      {...props}
    />
  )
}
